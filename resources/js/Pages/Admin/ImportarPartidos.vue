                ...
                <div class="bg-green-50 border border-green-200 rounded-lg p-4 flex gap-3 shadow-sm items-start">
                    ...
                    <div>
                        ...
                        <p class="text-green-700 text-[13px] font-medium leading-snug">
                            Si subís un Excel que ya habías cargado antes, el sistema <b>NO duplicará</b> los partidos. Solamente actualizará la información (como cambios de cancha) de los partidos que ya existen.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white border border-[#E5E7EB] rounded p-7 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
                    <form @submit.prevent="submit" class="flex flex-col gap-6">
                        ...
                        <div class="pt-4 border-t border-[#E5E7EB] mt-2">
                            <button type="submit" :disabled="form.processing || !nombreArchivo"
                ...
                <div class="relative z-10 p-7">
                    ...
                    <ul class="text-white/80 font-medium space-y-4">
                        <li class="flex items-start gap-3">
                            ...
                            <p class="leading-relaxed">El sistema extraerá automáticamente el <strong class="text-white">DÍA</strong> y la <strong class="text-white">HORA</strong> de cada partido directamente del archivo Excel.</p>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-[#D4A843] font-black mt-0.5 opacity-70">02.</span>
                            <p class="leading-relaxed">Es necesario que la palabra <strong class="text-white">LOCAL</strong> y <strong class="text-white">VISITANTE</strong> existan en la fila principal para detectar los equipos.</p>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-[#D4A843] font-black mt-0.5 opacity-70">03.</span>
                            <p class="leading-relaxed">Si el Excel trae nombres de árbitros, el sistema los emparejará automáticamente con la base de datos de usuarios.</p>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-[#D4A843] font-black mt-0.5 opacity-70">04.</span>
                            <p class="leading-relaxed"><strong class="text-white">Filtro Inteligente:</strong> El sistema detecta y omite los partidos repetidos automáticamente aunque subas el Excel varias veces.</p>
                        </li>
                    </ul>
                    ...
                    <div class="mt-8 pt-5 border-t border-white/10 flex items-center gap-3">
                        ...
                        <p class="text-sm text-white/50 leading-tight">Procesamiento seguro. Los datos no se van a publicar hasta que los confirmes en la pizarra.</p>
                    </div>
                </div>
            </div>
