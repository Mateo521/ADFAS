...
// Colores refinados y elegantes para las etiquetas institucionales
const colorTipo = (tipo) => {
    ...
    return 'bg-[#0D1B3E]/5 text-[#0D1B3E] border-[#0D1B3E]/20'; // Info
};
</script>
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
                <p class="text-[11px] font-black tracking-[3px] uppercase text-[#A87C20] mb-2">Comunicados Oficiales</p>
        ...
        <div class="space-y-6 max-w-7xl">
            ...
            <div v-if="noticias.length === 0" class="bg-white border border-[#E5E7EB] rounded p-16 text-center shadow-sm relative overflow-hidden">
            ...
            <Link v-for="noticia in noticias" :key="noticia.id" :href="route('noticias.show', noticia.id)" 
                ...
                <div class="flex-1 p-6 md:p-8 flex flex-col justify-center">
                    ...
                    <div v-if="noticia.archivo_ruta" class="mt-5 inline-flex items-center gap-2 text-[#162554] bg-[#F7F5F0] px-4 py-2 rounded-lg border border-[#E5E7EB] text-[11px] font-bold tracking-wide uppercase self-start group-hover:border-[#D4A843]/40 transition-colors">
