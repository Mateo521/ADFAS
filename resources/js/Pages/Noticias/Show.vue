        ...
        <div class="max-w-7xl mx-auto pb-12 font-['Lato',sans-serif]">
            ...
            <article class="bg-white border border-[#E5E7EB] rounded overflow-hidden shadow-[0_8px_30px_rgba(13,27,62,0.04)]">
                ...
                <div class="p-8 md:p-14">
                    ...
                    <div v-if="noticia.archivo_ruta" class="bg-[#0D1B3E]  p-8 md:p-10 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8 border border-[#D4A843]/30 shadow-lg mb-10">
                        ...
                        <div class="relative z-10 flex-1 text-center md:text-left">
                            ...
                            <p class="text-[15px] text-white/80 font-medium leading-relaxed">El comunicado incluye un documento</p>
                        </div>
                    ...
                    <div v-if="user.rol === 'admin'" class="bg-[#F9FAFB] border border-[#E5E7EB]  p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
